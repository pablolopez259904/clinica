...
<?php
    ...
    $db_conexionPEdit -> real_query("SELECT p.id_paciente as id, p.nombres,p.apellidos, p.fecha_nacimiento, p.telefono, p.direccion, p.correo_electronico FROM clinicaproyecto_2021.pacientes AS p WHERE p.id_paciente = $idEdit");
    ...
    $db_conexionDEdit->real_query("SELECT id_empleado AS id, nombres, apellidos FROM clinicaproyecto_2021.empleados WHERE id_puesto=1;");
